...
static inline void *__list_find(struct list_head *head, size_t offset, char (*equality_func)(void*, void*), void *context)
{
...
#define list_next(item, member) \
    list_first(typeof(*item), &(item)->member, member)

#define list_is_first(head, item, member) \
    (item->member.prev == head)

#define list_is_last(head, item, member) \
